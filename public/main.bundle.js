...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_angular_flash_message__ = __webpack_require__("../../../../angular-flash-message/dist/index.js");
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.success('You are now loggen in', { dalay: 5000 });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.flashMessage.danger(data.message, { dalay: 5000 });
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.success('You are now registered and can log in', { dalay: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.danger('Something went wrong', { dalay: 3000 });
